/**
 * @file components/Auth/icons/index.js
 * @description SVG icons for login form
 */
...
export const IconEye = ({ off }) => (
  <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" style={{width:16,height:16}}>
    {off ? (
      <>
        <path d="M2 2l12 12M6.5 6.6A3 3 0 0111.4 9.5"/>
        <path d="M1.5 8S4 3 8 3c.8 0 1.5.1 2.2.4M14.5 8S12 13 8 13c-1.5 0-2.8-.5-3.9-1.3"/>
      </>
    ) : (
      <>
